                ...
                <Toolbar>
                    ...
                    <div className={classes.grow} >
                        <ButtonGroup variant="contained" color="primary" aria-label="contained primary button group">
                            ...
                            <Link to="/topics" style={{textDecoration: 'none'}}><Button style = {{color: 'white'}}>Topics</Button></Link>
                            <Link to="/blog" style={{textDecoration: 'none'}}><Button style = {{color: 'white'}}>Blogs</Button></Link>
                        </ButtonGroup>
